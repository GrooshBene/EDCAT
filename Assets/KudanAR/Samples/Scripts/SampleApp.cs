...
namespace Kudan.AR.Samples
{
	...
	public class SampleApp : MonoBehaviour
	{
        ...
        public void Shot() {
           GameObject temp = Instantiate(bullet,bullet_Pos.transform.position,Quaternion.identity) as GameObject;
            temp.transform.parent = GameObject.Find("Markerless").transform;
